...
public class TracksRecyclerAdapter extends RecyclerView.Adapter<PopularVideoViewHolder> {
    private ArrayList<Music> musics;
    private Context context;
    private SelectedMusicProvider selectedMusicProvider;
    private ArrayList<SelectItem> selectedItems;

    public TracksRecyclerAdapter(Context context, ArrayList<Music> musics, SelectedMusicProvider selectedMusicProvider) {
    ...
    public PopularVideoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_tracks, parent, false);
